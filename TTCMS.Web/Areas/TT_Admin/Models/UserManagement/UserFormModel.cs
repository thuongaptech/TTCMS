...
namespace TTCMS.Web.Areas.TT_Admin.Models
{
    public partial class UserFormModel
    {
        ...
        {
            this.ListRole = new List<System.Web.Mvc.SelectListItem>();
        }
        ...
        [DataType(DataType.Password)]
        [Compare("Password", ErrorMessageResourceType = typeof(TTCMS.Resources.Resources), ErrorMessageResourceName = "ConfirmPassword")]
        [Display(Name = "ConfirmPasswordText", ResourceType = typeof(TTCMS.Resources.Resources))]
        public string ConfirmPassword { get; set; }
         [EmailAddress(ErrorMessage = null,ErrorMessageResourceType = typeof(Resources.Resources), ErrorMessageResourceName = "EmailAddressValid")]
         [StringLength(250, ErrorMessageResourceType = typeof(TTCMS.Resources.Resources), ErrorMessageResourceName = "LenghtString250", ErrorMessage = null)]
        ...
        public bool Activated { get; set; }
         ...
         public ICollection<System.Web.Mvc.SelectListItem> ListRole { get; set; }
    }
}
