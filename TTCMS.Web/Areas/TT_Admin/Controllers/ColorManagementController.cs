...
{
    [Authorize]
    public class ColorManagementController : BaseController
    {
        private readonly ICategoryService categoryService;
        private readonly ILanguageService languageService;
        public ColorManagementController(ICategoryService categoryService, ILanguageService languageService)
        {
        ...
        public ActionResult Index(int? page = 1, string show = "", string search = "")
        {
            ...
            {
                return PartialView("_ColorCateTable", table);
            }
        ...
        public ActionResult Create()
        {
            ...
            model.Order = categoryService.GetSort(CategoryType.Color);
        ...
        public ActionResult Create(CategoryViewModel model)
        {
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    model.CategoryType = CategoryType.Color;
        ...
        {
            var all = categoryService.GetList(CategoryType.Color).OrderBy(x => x.Order).ToList();
