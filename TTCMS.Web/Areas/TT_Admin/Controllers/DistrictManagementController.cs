...
namespace TTCMS.Web.Areas.TT_Admin.Controllers
{
    ...
    public class DistrictManagementController : BaseController
    {
        ...
        public DistrictManagementController(ICategoryService categoryService, ILanguageService languageService)
        {
        ...
        public ActionResult Index(int? page = 1, string show = "", string search = "")
        {
            ...
            {
                return PartialView("_DistrictCateTable", table);
            }
        ...
        public ActionResult Create()
        {
            ...
            model.Order = categoryService.GetSort(CategoryType.District);
        ...
        public ActionResult Create(CategoryViewModel model)
        {
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    model.CategoryType = CategoryType.District;
        ...
        {
            var all = categoryService.GetList(CategoryType.District).OrderBy(x => x.Order).ToList();
