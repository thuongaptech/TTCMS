...
{
    [Authorize]
    public class ProCateManagementController : BaseController
    {
        private readonly ICategoryService categoryService;
        private readonly ILanguageService languageService;
        public ProCateManagementController(ICategoryService categoryService, ILanguageService languageService)
        {
        ...
        [AuthorizeUser(FunctionID = "PROCATE ", RoleID = "VIEW")]
        [HttpGet]
        public ActionResult Index(int? page = 1, string show = "", string search = "")
        {
            ...
            {
                return PartialView("_ProCateTable", table);
            }
        ...
        [AuthorizeUser(FunctionID = "PROCATE", RoleID = "CREATE")]
        ...
        public ActionResult Create()
        {
            ...
            model.ShowProduct = 4;
            model.Order = categoryService.GetSort(CategoryType.Product);
        ...
        public ActionResult Create(CategoryViewModel model)
        {
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    model.CategoryType = CategoryType.Product;
        ...
        [AuthorizeUser(FunctionID = "PROCATE", RoleID = "EDIT")]
        ...
        [AuthorizeUser(FunctionID = "PROCATE", RoleID = "DELETE"), Log("{Id}")]
        ...
        {
            var all = categoryService.GetList(CategoryType.Product,show).OrderBy(x => x.Order).ToList();
