...
namespace TTCMS.Data.Infrastructure
{
    ...
    {
        #region Properties
        private TTCMSDbContext dataContext;
        ...
        protected TTCMSDbContext DbContext
        {
        ...
        public virtual IPagedList<T> GetPageASC<TOrder>(Page page, Expression<Func<T, bool>> where, Expression<Func<T, TOrder>> order)
        {
